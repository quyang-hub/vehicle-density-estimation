...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='dataset/TRANCOS_v3/', help='data path  dataset/TRANCOS_v3/')
    parser.add_argument('--dataset', default='Trancos', help='dataset name: Trancos, WebCamT')
    ...
    if args.dataset.lower() == 'trancos':
        args.crop_size = 256
    elif args.dataset.lower() == 'webcamt':
        args.crop_size = 256
    else:
